...
const QUESTIONS = [
  {
    id: 1,
    q: "What is the standard distance between the target and archer in Olympic archery?",
    choices: ["50 meters", "70 meters", "100 meters", "120 meters"],
    answer: 1,
  },
  {
    id: 2,
    q: "Life insurance primarily provides:",
    choices: [
      "Long-term savings",
  ...
  {
    id: 4,
    q: "Health insurance mainly provides:",
    choices: [
  ...
  },
  {
    ...
    choices: [
      "Trip cancellation, baggage loss, and medical emergencies",
      "Buying flight tickets",
      "Visa charges",
      "Luggage color selection",
    ],
    answer: 0,
  },
  {
    id: 10,
    q: "Policy maturity refers to:",
    choices: [
      "End of policy term with payout",
      "Start of policy",
      "Loan approval",
      "Penalty charges",
    ],
...
function ResultDialog({
 ...
 async function handlePass() {
  ...
  // 🔥 IMPORTANT: full reload so middleware reads NEW JWT
