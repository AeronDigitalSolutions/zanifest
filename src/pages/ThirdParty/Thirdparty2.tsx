      ...
      <div className={styles.wrapper}>
        ...
        <aside className={styles.sidebar}>
          <div className={styles.carInfo}>
            ...
            <div className={styles.carDetails}>
              <p>IDV Cover (Insured Value): <b>Select IDV</b></p>
              <p>No Claim Bonus (NCB): <b>50%</b></p>
              <p>Policy Expiry Date: <b>5-Aug-2025</b></p>
            </div>
          </div>
          ...
          <div className={styles.filterBox}>
            ...
            <div className={styles.filterSection}>
              <h5>Plan type</h5>
              <label><input type="checkbox" /> Comprehensive/Package plans</label>
              <label><input type="checkbox" /> Third Party plans</label>
            </div>

            <div className={styles.filterSection}>
              <h5>Addons</h5>
              <label><input type="checkbox" /> Zero Depreciation <span className={styles.mustBuy}>Must Buy</span></label>
        ...
        <main className={styles.mainContent}>
          ...
          <div className={styles.tabs}>
            <button className={`${styles.tab} ${styles.active}`}>Complete Protection</button>
          ...
          <h3 className={styles.sectionTitle}>
            16 Third Party plans <span className={styles.priceTag}>@ ₹3416</span>
          </h3>
          ...
          <div className={styles.planCard}>
            ...
            <div className={styles.planRight}>
              <p className={styles.planPrice}>₹3,416</p>
          ...
          <div className={styles.planCard}>
            <div className={styles.planLeft}>
              <Image className={styles.img} src={zurich} alt="Zurich Kotak Logo" />
              <div className={styles.planText}>
                <p className={styles.planType}>Third Party</p>
                <p className={styles.greenText}>Buy without inspection!</p>
              </div>
          ...
          <p className={styles.sectionSub}>
            Require video of car after payment. Cover damages to both your car & third party.
          </p>
          ...
          <div className={styles.planCard}>
            <div className={styles.planLeft}>
              ...
              <div className={styles.planText}>
                ...
                <p className={styles.orangeText}>Car video inspection required</p>
              </div>
            </div>
            <div className={styles.planRight}>
              <p className={styles.planPrice}>₹3,943</p>
        ...
        <aside className={styles.rightSidebar}>
          <div className={styles.benefitsBox}>
            ...
            <ul>
              <li><FiCheckCircle /> 24x7 claim support, even on holidays</li>
              <li><FiCheckCircle /> Get a dedicated claims manager</li>
              <li><FiCheckCircle /> Ensure you get highest claim payout</li>
              <li><FiCheckCircle /> 1000+ Network Garages across India</li>
              <li><FiCheckCircle /> Quick repair within 5 days</li>
              <li><FiCheckCircle /> Car pick-up and drop on all 365 days</li>
            </ul>
            <div className={styles.agentBox}>
              <Image src={agent} alt="Agent Icon" width={40} height={40} className={styles.agentImg} />
              <p><b>Amit Sharma</b>, 98*****240</p>
            </div>
          </div>
        </aside>
      </div>
